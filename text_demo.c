...
void Demo_Text_FillBoxSlow1(void)
{
	...
	Text_FillBoxSlow(global_system->screen_[ID_CHANNEL_B], 0, 6, global_system->screen_[ID_CHANNEL_B]->text_cols_vis_ - 1, 35, CH_CHECKERED1, COLOR_BLACK, BG_COLOR_WHITE, CHAR_AND_ATTR);
	WaitForUser();
}
...
void Demo_Text_FillBoxSlow2(void)
{
	...
	Text_FillBoxSlow(global_system->screen_[ID_CHANNEL_B], 2, 9, global_system->screen_[ID_CHANNEL_B]->text_cols_vis_ - 1, 35, CH_CHECKERED3, COLOR_BLUE, COLOR_DK_BLUE, CHAR_AND_ATTR);
	WaitForUser();
}
...
void Demo_Text_FillBox1(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], 4, 11, global_system->screen_[ID_CHANNEL_B]->text_cols_vis_ - 1, 32, CH_CHECKERED1, COLOR_BLACK, BG_COLOR_WHITE);
	WaitForUser();
}
...
void Demo_Text_FillBox2(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], 6, 13, global_system->screen_[ID_CHANNEL_B]->text_cols_vis_ - 1, 39, CH_CHECKERED3, COLOR_BLUE, COLOR_DK_BLUE);
	WaitForUser();
}
...
void Demo_Text_FillBox3(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], 0, 7, 3, 9, CH_RIGHT, COLOR_GREEN, COLOR_DK_BLUE);
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], 0, 10, 2, 12, CH_LEFT, COLOR_RED, COLOR_DK_BLUE);
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], 0, 13, 4, 16, CH_UP, COLOR_ORANGE, COLOR_DK_BLUE);
	WaitForUser();
}
...
void Demo_Text_InvertBox(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], 6, 10, 60, 35, CH_DIAMOND, COLOR_RED, BG_COLOR_WHITE);
...
void Demo_Text_SetCharAndColorAtXY(void)
{
	ShowDescription("Text_SetCharAndColorAtXY -> Draw various characters and colors at various locations on screen");	
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 0, 14, 33, FG_COLOR_BLACK, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 1, 14, 34, FG_COLOR_DK_RED, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 2, 14, 35, FG_COLOR_GREEN, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 3, 14, 36, FG_COLOR_BLUE, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 4, 14, 37, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 5, 14, 38, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 6, 14, 39, FG_COLOR_VIOLET, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 7, 14, 40, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 8, 14, 41, COLOR_BLACK, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 9, 14, 42, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 10,14, 43, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 11,14, 44, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 12,14, 45, FG_COLOR_DK_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 13,14, 46, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 14,14, 47, FG_COLOR_WHITE, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 15,14, 48, COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 0, 15, 33, FG_COLOR_WHITE, BG_COLOR_BLACK);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 1, 15, 34, FG_COLOR_WHITE, BG_COLOR_DK_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 2, 15, 35, FG_COLOR_WHITE, BG_COLOR_GREEN);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 3, 15, 36, FG_COLOR_WHITE, BG_COLOR_BLUE);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 4, 14, 37, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 5, 15, 38, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 6, 15, 39, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 7, 15, 40, FG_COLOR_WHITE, BG_COLOR_DK_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 8, 15, 41, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 9, 15, 42, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 10, 15, 43, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 11, 15, 44, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 12, 15, 45, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 13, 15, 46, FG_COLOR_WHITE, COLOR_RED);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 14, 15, 47, FG_COLOR_WHITE, BG_COLOR_LT_GRAY);
 	Text_SetCharAndColorAtXY(global_system->screen_[ID_CHANNEL_B], 15, 15, 48, FG_COLOR_WHITE, BG_COLOR_WHITE);
	WaitForUser();
}
...
void Demo_Text_DrawHLine1(void)
{
	...
	y = 10;
	line_len = 20;
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y, line_len, CH_HEART, FG_COLOR_GREEN, BG_COLOR_BLACK, CHAR_ONLY);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + 2, line_len, CH_HEART, FG_COLOR_GREEN, BG_COLOR_BLACK, CHAR_ONLY);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + 4, line_len, CH_HEART, FG_COLOR_GREEN, BG_COLOR_BLACK, CHAR_ONLY);
	Text_DrawVLine(global_system->screen_[ID_CHANNEL_B], x + 10, y - 1, line_len, CH_CLUB, FG_COLOR_YELLOW, BG_COLOR_BLACK, CHAR_ONLY);
	Text_DrawVLine(global_system->screen_[ID_CHANNEL_B], x + 15, y - 1, line_len + 5, CH_CLUB, FG_COLOR_YELLOW, BG_COLOR_BLACK, CHAR_ONLY);
...
void Demo_Text_DrawHLine2(void)
{
	...
	y = 10;
	line_len = 20;
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y, line_len, CH_HEART, FG_COLOR_GREEN, BG_COLOR_BLACK, ATTR_ONLY);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + 2, line_len, CH_HEART, FG_COLOR_WHITE, BG_COLOR_GREEN, ATTR_ONLY);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + 4, line_len, CH_HEART, FG_COLOR_BLUE, BG_COLOR_BLACK, ATTR_ONLY);
	Text_DrawVLine(global_system->screen_[ID_CHANNEL_B], x + 10, y - 1, line_len, CH_CLUB, FG_COLOR_YELLOW, BG_COLOR_BLUE, ATTR_ONLY);
	Text_DrawVLine(global_system->screen_[ID_CHANNEL_B], x + 15, y - 1, line_len + 5, CH_CLUB, FG_COLOR_YELLOW, BG_COLOR_BLACK, ATTR_ONLY);
...
void Demo_Text_DrawHLine3(void)
{
	...
	y = 10;
	line_len = 20;
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y, line_len, CH_HEART, FG_COLOR_GREEN, BG_COLOR_BLACK, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + 2, line_len, CH_DIAMOND, FG_COLOR_WHITE, BG_COLOR_GREEN, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + 4, line_len, CH_CLUB, FG_COLOR_BLUE, BG_COLOR_BLACK, CHAR_AND_ATTR);
	Text_DrawVLine(global_system->screen_[ID_CHANNEL_B], x + 10, y - 1, line_len, CH_CLUB, FG_COLOR_YELLOW, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawVLine(global_system->screen_[ID_CHANNEL_B], x + 15, y - 1, line_len + 5, CH_SMILEY1, FG_COLOR_YELLOW, BG_COLOR_BLACK, CHAR_AND_ATTR);
...
void Demo_Text_NamedColors(void)
{
	...
	{
		Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x, y + i, line_len, the_char, i, BG_COLOR_BLUE, CHAR_AND_ATTR);
		Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + 30, y + i, line_len, CH_MIDDOT, FG_COLOR_BLACK, i, CHAR_AND_ATTR);
	}

	// manually line up named colors
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 0, 6, the_char, FG_COLOR_BLACK, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 1, 6, the_char, FG_COLOR_DK_RED, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 2, 6, the_char, FG_COLOR_DK_GREEN, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 3, 6, the_char, FG_COLOR_DK_YELLOW, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 4, 6, the_char, FG_COLOR_DK_BLUE, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 5, 6, the_char, FG_COLOR_ORANGE, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_A], x + line_len + 2, y + 6, 6, the_char, FG_COLOR_DK_CYAN, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 7, 6, the_char, FG_COLOR_LT_GRAY, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 8, 6, the_char, FG_COLOR_DK_GRAY, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 9, 6, the_char, FG_COLOR_ORANGE, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 10, 6, the_char, FG_COLOR_GREEN, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 11, 6, the_char, FG_COLOR_YELLOW, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 12, 6, the_char, FG_COLOR_BLUE, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 13, 6, the_char, FG_COLOR_VIOLET, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 14, 6, the_char, FG_COLOR_CYAN, BG_COLOR_BLUE, CHAR_AND_ATTR);
	Text_DrawHLine(global_system->screen_[ID_CHANNEL_B], x + line_len + 2, y + 15, 6, the_char, FG_COLOR_WHITE, BG_COLOR_BLUE, CHAR_AND_ATTR);
	WaitForUser();
}
...
void Demo_Text_DrawBox(void)
{
	...
	Text_DrawBox(global_system->screen_[ID_CHANNEL_B], x, y, h_line_len, v_line_len, the_char, FG_COLOR_CYAN, BG_COLOR_DK_CYAN, CHAR_AND_ATTR);
	WaitForUser();
}
...
void Demo_Text_DrawBoxCoords(void)
{
	...
	Text_DrawBoxCoords(global_system->screen_[ID_CHANNEL_B], x1, y1, x2, y2, the_char, FG_COLOR_LT_GRAY, BG_COLOR_DK_GRAY, CHAR_AND_ATTR);
	WaitForUser();
}
...
void Demo_Text_DrawBoxCoordsFancy(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], x1+1, y1+1, x2-1, y2-1, CH_CHECKERED3, FG_COLOR_LT_GRAY, BG_COLOR_WHITE);
	Text_DrawBoxCoordsFancy(global_system->screen_[ID_CHANNEL_B], x1, y1, x2, y2, FG_COLOR_LT_GRAY, BG_COLOR_DK_GRAY);
	WaitForUser();
}
...
void Demo_Text_DrawStringAtXY(void)
{
	...
	{	
		Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_B], i*2, i, the_message, FG_COLOR_YELLOW, BG_COLOR_DK_BLUE);
	}
...
void Demo_Text_DrawStringInBox1(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], x1+1, y1+1, x2-1, y2-1, ' ', BG_COLOR_CYAN, BG_COLOR_BLACK);
...
void Demo_Text_DrawStringInBox2(void)
{
	...
	Text_FillBox(global_system->screen_[ID_CHANNEL_B], x1+1, y1+1, x2-1, y2-1, ' ', FG_COLOR_LT_GRAY, BG_COLOR_WHITE);
...
void Demo_Text_ScreenResolution3(void)
{
	...
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, y, the_message, FG_COLOR_BLACK, BG_COLOR_GREEN);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, y + 1, (char*)"0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789", FG_COLOR_DK_BLUE, BG_COLOR_YELLOW);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, y + 2, (char*)"<-START OF LINE", FG_COLOR_BLACK, BG_COLOR_GREEN);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_B], 0, y + 3, (char*)"800x600 should now be showing on Channel A", FG_COLOR_RED, BG_COLOR_GREEN);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, 70, (char*)"ROW70", FG_COLOR_BLACK, BG_COLOR_GREEN);
...
void Demo_Text_ScreenResolution4(void)
{
	...
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, y, the_message, FG_COLOR_BLACK, BG_COLOR_GREEN);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, y + 1, (char*)"0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567", FG_COLOR_DK_BLUE, BG_COLOR_YELLOW);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, y + 2, (char*)"<-START OF LINE", FG_COLOR_BLACK, BG_COLOR_GREEN);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_B], 0, y + 3, (char*)"1024x768 should now be showing on Channel A", FG_COLOR_RED, BG_COLOR_GREEN);
	Text_DrawStringAtXY(global_system->screen_[ID_CHANNEL_A], 0, 91, (char*)"ROW91", FG_COLOR_BLACK, BG_COLOR_GREEN);
	Text_ShowFontChars(global_system->screen_[ID_CHANNEL_A], y + 4);
