...
// 	global_system = the_system;
	...
	DEBUG_OUT(("%s %d: Fonts loaded ok. Creating menu manager...", __func__ , __LINE__));
...
{
	unsigned char font_data_osf_espy_bold_10[] = { 
	...
	unsigned char*	the_new_font_data = font_data_osf_espy_bold_10;
	Font*			the_font;
...
{
	unsigned char font_data_osf_menu_reg_10[] = 
	{ 
	...
	unsigned char*	the_new_font_data = font_data_osf_menu_reg_10;
	Font*			the_font;
